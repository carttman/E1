...
public class ProjectilePool : MonoBehaviour
{
    ...
    /// <summary>
    ///     The maximum size of the pool. When the pool reaches the max size then any further instances returned to the pool
    ///     will be ignored and can be garbage collected. This can be used to prevent the pool growing to a very large size.
    /// </summary>
    ...
    {
        var newPool = gameObject.AddComponent<ProjectilePool>();
