...
public class Element_Information : MonoBehaviour
{
    ...
    {   // 다음 웨이브까지 표시됐으면 업데이트 중지
        ...
        var currWaveEnemyElement = waveSpawner.Waves[waveSpawner.WaveIndex].enemy.GetComponent<StatsComponent>().element;
        var nextWaveEnemyElement = waveSpawner.Waves[waveSpawner.WaveIndex + 1].enemy.GetComponent<StatsComponent>().element;
